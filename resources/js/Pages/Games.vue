...
let defaultCards1 = [
    ...
    {'id' : 5, 'class': 'test', 'img' : 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c9/PhpStorm_Icon.svg/512px-PhpStorm_Icon.svg.png?20200803075927'},
    {'id' : 6, 'class': 'test', 'img' : 'https://cdn.prod.website-files.com/6409b6df2b71f3fef571083d/6412dc65ae08c3b88613bb3f_615dbf243f4ded4697c2d3b7_esgaia_portfolio.png'},
    {'id' : 6, 'class': 'test', 'img' : 'https://cdn.prod.website-files.com/6409b6df2b71f3fef571083d/6412dc65ae08c3b88613bb3f_615dbf243f4ded4697c2d3b7_esgaia_portfolio.png'},
    {'id' : 7, 'class': 'test', 'img' : 'https://cdn.prod.website-files.com/6409b6df2b71f3fef571083d/6412dc65ae08c3b88613bb3f_615dbf243f4ded4697c2d3b7_esgaia_portfolio.png'},
    {'id' : 7, 'class': 'test', 'img' : 'https://cdn.prod.website-files.com/6409b6df2b71f3fef571083d/6412dc65ae08c3b88613bb3f_615dbf243f4ded4697c2d3b7_esgaia_portfolio.png'},
    {'id' : 8, 'class': 'test', 'img' : 'https://cdn.prod.website-files.com/6409b6df2b71f3fef571083d/6412dc65ae08c3b88613bb3f_615dbf243f4ded4697c2d3b7_esgaia_portfolio.png'},
    {'id' : 8, 'class': 'test', 'img' : 'https://cdn.prod.website-files.com/6409b6df2b71f3fef571083d/6412dc65ae08c3b88613bb3f_615dbf243f4ded4697c2d3b7_esgaia_portfolio.png'},
]
...
function gameDone(){
    ...
    game.result = 0;
    game.status = '';
    alert('You completed the memory in -- seconds');
}
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <div class="p6">
                        ...
                        <p v-else>A game is ongoing. Your bet is {{game.wager}} credits</p>
                        <div id="board">
